...
EXAMPLES_BASE_URL="https://raw.githubusercontent.com/$ORG_NAME/$ACTIONS_REPO/dev-actions/examples/workflows"
...
echo "   - Migration checklist: https://github.com/$ORG_NAME/$ACTIONS_REPO/blob/dev-actions/docs/repository-migration-checklist.md"
echo
